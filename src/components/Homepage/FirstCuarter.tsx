...
export const FirstCuarter: FC = () => {
    return (
        <div className=" bg-white divide-x-2 mb-3 first_quarter_background_gradient" style={{ height: '1400px' }}>
        
           <div className="title-wrapper flex flex-col h-3/6 justify-center pl-20">
