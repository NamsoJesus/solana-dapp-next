    ...
    <div className="flex-none px-0 pb-4 pt-4 w-fit absolute ">
      ...
      <div className="navbar mb-2  gradient-transparency text-neutral-content">
        ...
        <div className="navbar-end lg:flex text-xl">
          ...
          <Link href="/">
              <a className="btn btn-ghost btn-sm rounded-btn text-xl">Galeria</a>
            </Link>
            <Link href="/basics">
              <a className="btn btn-ghost btn-sm rounded-btn text-xl">Inicio</a>
            </Link>
            
            <Link href="/nft">
              <a className="btn btn-ghost btn-sm rounded-btn text-xl">Whitepaper</a>
            </Link>
            {/* <Link href="/">
